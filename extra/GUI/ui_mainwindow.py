...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.stackedWidget.setGeometry(QRect(190, 70, 261, 201))
        self.page = QWidget()
